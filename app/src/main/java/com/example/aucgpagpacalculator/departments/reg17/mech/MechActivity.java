...
public class MechActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sem1.setOnClickListener(view ->{
            Intent s1 = new Intent(getApplicationContext(), MechS1Activity.class);
            startActivity(s1);
        } );

        sem2.setOnClickListener(view ->{
            Intent s2 = new Intent(getApplicationContext(), MechS2Activity.class);
            startActivity(s2);
        } );

        sem3.setOnClickListener(view ->{
            Intent s3 = new Intent(getApplicationContext(), MechS3Activity.class);
            startActivity(s3);
        } );

        sem4.setOnClickListener(view ->{
            Intent s4 = new Intent(getApplicationContext(), MechS4Activity.class);
            startActivity(s4);
        } );

        sem5.setOnClickListener(view ->{
            Intent s5 = new Intent(getApplicationContext(), MechS5Activity.class);
            startActivity(s5);
        } );

        sem6.setOnClickListener(view ->{
            Intent s6 = new Intent(getApplicationContext(), MechS6Activity.class);
            startActivity(s6);
        } );

        sem7.setOnClickListener(view ->{
            Intent s7 = new Intent(getApplicationContext(), MechS7Activity.class);
            startActivity(s7);
        } );

        sem8.setOnClickListener(view ->{
            Intent s8 = new Intent(getApplicationContext(), MechS8Activity.class);
            startActivity(s8);
        } );
    }
}