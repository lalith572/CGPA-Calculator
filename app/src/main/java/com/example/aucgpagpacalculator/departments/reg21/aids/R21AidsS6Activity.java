...
public class R21AidsS6Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_aids_s6);
        ...
        r21s6gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 3 + S7marks * 0);
