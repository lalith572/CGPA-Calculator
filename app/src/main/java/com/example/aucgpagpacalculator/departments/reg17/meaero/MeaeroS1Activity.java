...
public class MeaeroS1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_meaero_s1);
        ...
        s1gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate (String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 4 + S4marks * 4 + S5marks * 3 + S6marks * 3 + L1marks * 2 + L2marks * 1);
