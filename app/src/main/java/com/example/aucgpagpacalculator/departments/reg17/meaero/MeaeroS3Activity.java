...
public class MeaeroS3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_meaero_s3);
        ...
        s3gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate (String grade1, String grade2, String grade3, String grade4){
                ...
                double L1marks = gradePoint(grade3);
                double L2marks = gradePoint(grade4);

                // Calculate the GPA based on the marks
                double gpa = (S1marks * 3 + S2marks * 3 + L1marks * 6 + L2marks * 1);
                // calculate gp based on the marks
                double S1gp,S2gp,L1gp,L2gp;
