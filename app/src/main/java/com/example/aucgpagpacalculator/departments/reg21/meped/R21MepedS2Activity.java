package com.example.aucgpagpacalculator.departments.reg21.meped;
...
public class R21MepedS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_meped_s2);
        ...
        r21s2gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double Gpa = calculate(grade1, grade2, grade3, grade4, grade5, grade6, grade7, grade8);
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                    grade4, String grade5, String grade6, String grade7, String grade8) {
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 4 + S4marks * 3 + S5marks * 3 + S6marks * 0 + L1marks * 1.5 + L2marks * 1.5);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,L1gp,L2gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + L1gp + L2gp);
