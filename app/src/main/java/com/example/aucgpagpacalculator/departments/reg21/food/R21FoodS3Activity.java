...
public class R21FoodS3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_food_s3);
        ...
        r21s3gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 4 + S3marks * 3 + S4marks * 3 + S5marks * 4 + S6marks * 3 + L1marks * 2 + L2marks * 2 + L3marks * 1);
