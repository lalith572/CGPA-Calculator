package com.example.aucgpagpacalculator.departments.reg17.mca;
...
public class McaS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mca_s2);
        ...
        s2gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 3 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + L1marks * 2 + L2marks * 2 + L3marks * 2);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,L1gp,L2gp,L3gp;
