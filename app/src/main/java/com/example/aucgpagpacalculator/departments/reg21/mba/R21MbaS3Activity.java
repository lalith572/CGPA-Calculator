...
public class R21MbaS3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_mba_s3);
        ...
        r21s3gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double S8marks = gradePoint(grade8);
                double L1marks = gradePoint(grade9);
                double L2marks = gradePoint(grade10);

                // Calculate the GPA based on the marks
                double gpa = (S1marks * 3 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 3 + S7marks * 3 + S8marks * 3 + L1marks * 2 + L2marks * 2);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,S7gp,S8gp,L1gp,L2gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + S7gp + S8gp + L1gp + L2gp);
