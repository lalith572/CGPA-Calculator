...
public class R21MecseS3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_mecse_s3);
        ...
        r21s3gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double L1marks = gradePoint(grade5);

                // Calculate the GPA based on the marks
                double gpa = (S1marks * 3 + S2marks * 3 + S3marks * 4 + S4marks * 3 + L1marks * 6);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,L1gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + L1gp);
