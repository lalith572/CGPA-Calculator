package com.example.aucgpagpacalculator.departments.reg17.food;
...
public class FoodS1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_food_s1);
