package com.example.aucgpagpacalculator.departments.reg21.agri;
...
public class R21AgriS3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_agri_s3);

        Button r21s3gpabtn = findViewById(R.id.s3gpabtn);
        TextView r21s3gpatv = findViewById(R.id.s3gpatextView);
        ...
        r21s3gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String grade10 = spinner10.getSelectedItem().toString();

                // Calculate the GPA based on the grades
                double Gpa = calculate(grade1, grade2, grade3, grade4, grade5, grade6, grade7, grade8 , grade9 , grade10);


                r21s3gpatv.setText(Gpa + "  ");
            }

            public double calculate(String grade1, String grade2, String grade3, String
                    grade4, String grade5, String grade6, String grade7, String grade8, String grade9, String grade10) {
                ...
                double L1marks = gradePoint(grade7);
                double L2marks = gradePoint(grade8);
                double L3marks = gradePoint(grade9);
                double L4marks = gradePoint(grade10);

                // Calculate the GPA based on the marks
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 3 + L1marks * 2 + L2marks * 1.5 + L3marks * 1.5 + L4marks * 1);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,L1gp,L2gp,L3gp,L4gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + L1gp + L2gp + L3gp + L4gp);
