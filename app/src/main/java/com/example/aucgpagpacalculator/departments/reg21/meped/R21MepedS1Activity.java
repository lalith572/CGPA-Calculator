...
public class R21MepedS1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_meped_s1);
        ...
        r21s1gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 4 + S3marks * 4 + S4marks * 3 + S5marks * 2 + S6marks * 3 + S7marks * 0 + L1marks * 1.5 + L2marks * 2.5);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,S7gp,L1gp,L2gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + S7gp + L1gp + L2gp);
