package com.example.aucgpagpacalculator.departments.reg21.mca;
...
public class R21McaS1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_mca_s1);

        Button r21s1gpabtn = findViewById(R.id.s1gpabtn);
        TextView r21s1gpatv = findViewById(R.id.s1gpatextView);
        ...
        r21s1gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 2 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 4 + S7marks * 0 + L1marks * 2 + L2marks * 2 + L3marks * 1);
