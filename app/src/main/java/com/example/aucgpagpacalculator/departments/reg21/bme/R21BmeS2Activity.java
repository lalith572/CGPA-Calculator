...
public class R21BmeS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_bme_s2);
        ...
        r21s2gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 2 + S2marks * 4 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 4 + S7marks * 1 + L1marks * 2 + L2marks * 2 + L3marks * 2);
