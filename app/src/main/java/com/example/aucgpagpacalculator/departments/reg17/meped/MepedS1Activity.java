...
public class MepedS1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_meped_s1);
        ...
        s1gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate (String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 4 + S6marks * 3 + L1marks * 2);
                // calculate gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,L1gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + L1gp );
                double t_gpa = gpa / gp;
                return t_gpa;
            }
