...
public class MecseS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mecse_s2);
        ...
        s2gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public double calculate (String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 3 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 3 + L1marks * 2 + L2marks * 1);
