...
public class AeroS4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aero_s4);

        Button s4gpabtn = findViewById(R.id.s4gpabtn);
        TextView s4gpatv = findViewById(R.id.s4gpatextView);
        ...
        s4gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 4 + S6marks * 4 + L1marks * 2 + L2marks * 1);
