...
public class R21CybersecS7Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_cybersec_s7);
        ...
        r21s7gpabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double Gpa = calculate(grade1, grade2, grade3, grade4, grade5, grade6);
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                    grade4, String grade5, String grade6) {
                ...
                double gpa = (S1marks * 2 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + L1marks * 2);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,L1gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + L1gp);
