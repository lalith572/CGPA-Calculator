...
public class CivilS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_civil_s2);

        Button s2gpabtn = findViewById(R.id.s2gpabtn);
        TextView s2gpatv = findViewById(R.id.s2gpatextView);
        ...
        s2gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
