package com.example.aucgpagpacalculator.departments.reg21.mech;
...
public class R21MechS5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_mech_s5);

        Button r21s5gpabtn = findViewById(R.id.s5gpabtn);
        TextView r21s5gpatv = findViewById(R.id.s5gpatextView);
        ...
        r21s5gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double gpa = (S1marks * 4 + S2marks * 3 + S3marks * 3 + S4marks * 3 + S5marks * 3 + S6marks * 0 + L1marks * 1 + L2marks * 2);
