package com.example.aucgpagpacalculator.departments.reg21.cybersec;
...
public class R21CybersecS2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_r21_cybersec_s2);

        Button r21s2gpabtn = findViewById(R.id.s2gpabtn);
        TextView r21s2gpatv = findViewById(R.id.s2gpatextView);
        ...
        r21s2gpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public double calculate(String grade1, String grade2, String grade3, String
                ...
                double L1marks = gradePoint(grade8);
                double L2marks = gradePoint(grade9);
                double L3marks = gradePoint(grade10);

                // Calculate the GPA based on the marks
                double gpa = (S1marks * 2 + S2marks * 4 + S3marks * 3 + S4marks * 3 + S5marks * 4 + S6marks * 3 + S7marks * 1 + L1marks * 2 + L2marks * 2 + L3marks * 2);
                // Calculate the gp based on the marks
                double S1gp,S2gp,S3gp,S4gp,S5gp,S6gp,S7gp,L1gp,L2gp,L3gp;
                ...
                double gp = (S1gp + S2gp + S3gp + S4gp + S5gp + S6gp + S7gp + L1gp + L2gp + L3gp);
